...
[Decision Records](../decisions/README.md) record why this repository is arranged the way it is, and [roadmap items](../roadmap) record what is planned rather than delivered. A guide never restates either; it links to them and explains how to act.
