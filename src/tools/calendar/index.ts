...
export const calendarTools = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        startDateTime: { type: 'string', description: 'ISO 8601 start date/time for the query range (default: now)' },
        endDateTime: { type: 'string', description: 'ISO 8601 end date/time for the query range (default: startDateTime + 30 days)' }
      },
      required: []
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        comment: { type: 'string', description: 'Optional comment for declining the event' }
      },
      required: ['eventId']
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        comment: { type: 'string', description: 'Optional comment for cancelling the event' }
      },
      required: ['eventId']
    },
...
export { handleCancelEvent, handleCreateEvent, handleDeclineEvent, handleDeleteEvent, handleListEvents }
